...
1. **Phase 4 Closed Beta**: Self-hosted Package Registry (Docker: `docker.elastic.co/package-registry/package-registry`). Build and serve the GamePulse package; verify Fleet one-click install works with a colleague.

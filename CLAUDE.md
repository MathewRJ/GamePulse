...
| `elastic-package test system` | Not yet run | Requires local Docker stack + confirmed availability |
...
1. **`elastic-package test system`**: Run with local Docker stack (requires explicit user confirmation).

...
```bash
sudo pacman -U rigsignal-0.3.1-1-x86_64.pkg.tar.zst   # Arch, pre-built
sudo dpkg -i rigsignal_0.3.1-1_amd64.deb               # Debian / Ubuntu 24.04+
sudo rpm -i rigsignal-0.3.1-1.x86_64.rpm               # Fedora / RHEL / openSUSE
```
